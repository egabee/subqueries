...
export async function handleNftMsgAddToWhitelist(
  message: CosmosMessage<MsgAddToWhitelist>,
): Promise<void> {
...
export async function handleNftMsgRemoveFromWhitelist(
  message: CosmosMessage<MsgRemoveFromWhitelist>,
): Promise<void> {
